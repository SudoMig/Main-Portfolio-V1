      ...
      <div className='flex flex-nowrap w-full md:h-[38rem] lg:h-[42rem]'>
        <div className='group flex-auto md:w-10 lg:w-24 bg-MobileWebsiteDesign bg-cover bg-center transition-all duration-700 hover:grow-[2] z-0'>
          <div className='lg:hover:backdrop-blur-sm lg:h-full'>
            <div className='grid grid-cols-2 pt-6'>
              <div className='col-end-1 md:h-24 lg:-28 w-1 bg-PaleGreen rounded-full ml-6 mr-4'></div>
              <div className='box-content lg:w-56 font-semibold text-2xl text-white mt-2'>
                Website Design
              </div>
            </div>
            <div className='box-content md:w-64 lg:w-[24rem] text-left text-blue-50 text-lg ml-10 opacity-0 group-hover:opacity-100 transition-opacity-100 duration-200 ease-out'>
              <div className='mb-4'>
        ...
        <div className='group flex-auto md:w-10 lg:w-24 bg-WebsiteDevelopment bg-cover bg-center transition-all duration-700 hover:grow-[2] z-10'>
          <div className='lg:hover:backdrop-blur-sm lg:h-full'>
            ...
            <div className='box-content md:w-64 lg:w-[24rem] text-left text-blue-50 text-lg ml-10 opacity-0 group-hover:opacity-100 transition-opacity-100 duration-300 ease-out'>
              <div className='mb-4'>
