    ...
    >
      <div className='flex space-x-2 py-2'>
        <div className='py-1 md:py-0'>
          ...
          <input
            ...
            id='full-name'
            autoComplete='name'
            className='w-11/12 md:w-full border-b border-DarkGreen md:border-b-2 border-white bg-black outline-none focus:border-b md:focus:border-b-2 focus:border-LightGreen transition-all duration-200 '
            placeholder='Name'
          />
        </div>
        <div className='py-1 md:py-0'>
      ...
      <div>
        ...
        <textarea
          ...
          name='message'
          rows={1}
          className='mt-4 border-b border-DarkGreen md:border-b-2 border-white w-full bg-black outline-none focus:border-b md:focus:border-b-2 focus:border-LightGreen transition-all duration-200'
          placeholder='Message'
          defaultValue={''}
        />
      </div>
